...
import 'package:newsapp/Features/detailsFeature/ui/widgets/addToBookmarks.dart';
  ...
  Route? generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case Routes.detailView:
        final article = settings.arguments as Articles; // Extract the article
        return MaterialPageRoute(
          builder: (_) => MultiBlocProvider(
            providers: [
              BlocProvider<DetailsCubitCubit>(
                create: (context) => getIt<DetailsCubitCubit>()..loadArticleDetails(article),
              ),
